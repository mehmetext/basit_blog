        ...
        <div class="container px-4 px-lg-5">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto py-4 py-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link px-3 py-3 py-lg-4 <?php echo (g("do") == "biz-kimiz" ? "bg-dark bg-opacity-25" : null) ?>" href="<?= URL ?>/biz-kimiz">Biz Kimiz?</a></li>
                    ...
                    <?php if (!$kullanici) { ?>
                        ...
                        <li class="nav-item"><a class="nav-link ms-lg-2 my-3 btn btn-success text-light" href="<?= URL ?>/kayit">Kayıt Ol</a></li>
                    <?php } else { ?>
